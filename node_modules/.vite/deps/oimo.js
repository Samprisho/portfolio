...
Object.assign(Vec3.prototype, {
  ...
  add: function(a, b) {
    if (b !== void 0) return this.addVectors(a, b);
    this.x += a.x;
    this.y += a.y;
    this.z += a.z;
    return this;
  ...
  sub: function(a, b) {
    if (b !== void 0) return this.subVectors(a, b);
    this.x -= a.x;
    this.y -= a.y;
    this.z -= a.z;
    return this;
  ...
  cross: function(a, b) {
    if (b !== void 0) return this.crossVectors(a, b);
...
Object.assign(Quat.prototype, {
  ...
  multiply: function(q, p) {
    if (p !== void 0) return this.multiplyQuaternions(q, p);
  ...
  setFromMat33: function(m) {
    ...
    if (trace > 0) {
      ...
      var i2 = 0;
      if (m[4] > m[0]) i2 = 1;
      if (m[8] > m[i2 * 3 + i2]) i2 = 2;
      var j = (i2 + 1) % 3;
      var k = (i2 + 2) % 3;
      s = _Math.sqrt(m[i2 * 3 + i2] - m[j * 3 + j] - m[k * 3 + k] + 1);
      out[i2] = 0.5 * fRoot;
      s = 0.5 / fRoot;
      this.w = (m[j * 3 + k] - m[k * 3 + j]) * s;
      out[j] = (m[j * 3 + i2] + m[i2 * 3 + j]) * s;
      out[k] = (m[k * 3 + i2] + m[i2 * 3 + k]) * s;
      this.x = out[1];
      this.y = out[2];
      this.z = out[3];
    }
...
Object.assign(Mat33.prototype, {
  ...
  add: function(a, b) {
    if (b !== void 0) return this.addMatrixs(a, b);
  ...
  sub: function(a, b) {
    if (b !== void 0) return this.subMatrixs(a, b);
    var e = this.elements, te = a.elements;
    e[0] -= te[0];
    e[1] -= te[1];
    e[2] -= te[2];
  ...
  invert: function(m) {
    var te = this.elements, tm = m.elements, a00 = tm[0], a10 = tm[3], a20 = tm[6], a01 = tm[1], a11 = tm[4], a21 = tm[7], a02 = tm[2], a12 = tm[5], a22 = tm[8], b01 = a22 * a11 - a12 * a21, b11 = -a22 * a10 + a12 * a20, b21 = a21 * a10 - a11 * a20, det = a00 * b01 + a01 * b11 + a02 * b21;
    if (det === 0) {
  ...
  copy: function(m) {
    for (var i2 = 0; i2 < 9; i2++) this.elements[i2] = m.elements[i2];
    return this;
  },
...
Object.assign(LinearConstraint.prototype, {
  ...
  preSolve: function(timeStep, invTimeStep) {
    ...
    if (len > 5e-3) {
      len = (5e-3 - len) / len * invTimeStep * 0.05;
      this.velx *= len;
      this.vely *= len;
      this.velz *= len;
    } else {
...
Object.assign(TranslationalConstraint.prototype, {
  ...
  preSolve: function(timeStep, invTimeStep) {
    ...
    if (enableLimit) {
      ...
      if (!enableSpring) {
        if (this.limitVelocity > 5e-3) this.limitVelocity -= 5e-3;
        else if (this.limitVelocity < -5e-3) this.limitVelocity += 5e-3;
...
Object.assign(Translational3Constraint.prototype, {
  ...
  preSolve: function(timeStep, invTimeStep) {
    ...
    if (enableLimit1) {
      ...
      if (!enableSpring1) {
        if (this.limitVelocity1 > 5e-3) this.limitVelocity1 -= 5e-3;
        else if (this.limitVelocity1 < -5e-3) this.limitVelocity1 += 5e-3;
        else this.limitVelocity1 = 0;
      }
    } else {
      this.limitState1 = 2;
    ...
    if (enableLimit2) {
      ...
      if (!enableSpring2) {
        if (this.limitVelocity2 > 5e-3) this.limitVelocity2 -= 5e-3;
        else if (this.limitVelocity2 < -5e-3) this.limitVelocity2 += 5e-3;
        else this.limitVelocity2 = 0;
      }
    } else {
      this.limitState2 = 2;
    ...
    if (enableLimit3) {
      ...
      if (!enableSpring3) {
        if (this.limitVelocity3 > 5e-3) this.limitVelocity3 -= 5e-3;
        else if (this.limitVelocity3 < -5e-3) this.limitVelocity3 += 5e-3;
        else this.limitVelocity3 = 0;
      }
    } else {
      this.limitState3 = 2;
...
ContactConstraint.prototype = Object.assign(Object.create(Constraint.prototype), {
  ...
  preSolve: function(timeStep, invTimeStep) {
    ...
    for (var i3 = 0; i3 < this.num; i3++) {
      ...
      sepV = -(p.penetration + 5e-3) * invTimeStep * 0.05;
      if (norTar < sepV) norTar = sepV;
      c.norTar = norTar;
      c.last = i3 == this.num - 1;
      c = c.next;
    }
  },
  solve: function() {
...
Object.assign(Contact.prototype, {
  ...
  */
  updateManifold: function() {
    ...
    if (this.touching || this.dist < 1e-3) this.close = true;
    this.touching = true;
    i2 = num;
    while (i2--) {
      p = this.points[i2];
...
Object.assign(RigidBody.prototype, {
  ...
  setupMass: function(type, AdjustPosition) {
    var adjustPosition = AdjustPosition !== void 0 ? AdjustPosition : true;
...
Object.assign(SAPAxis.prototype, {
  ...
  removeElements: function(min, max) {
    var minIndex = -1;
    var maxIndex = -1;
    for (var i2 = 0, l = this.numElements; i2 < l; i2++) {
      var e = this.elements[i2];
      if (e == min || e == max) {
        if (minIndex == -1) {
          minIndex = i2;
        } else {
    ...
    for (i2 = minIndex + 1, l = maxIndex; i2 < l; i2++) {
      this.elements[i2 - 1] = this.elements[i2];
    }
    for (i2 = maxIndex + 1, l = this.numElements; i2 < l; i2++) {
  ...
  sort: function() {
    ...
    for (var i2 = 1, l = this.numElements; i2 < l; i2++) {
      var tmp = elements[i2];
      var pivot = tmp.value;
      var tmp2 = elements[i2 - 1];
      if (tmp2.value > pivot) {
        var j = i2;
        do {
          elements[j] = tmp2;
    ...
    while (count2 > 0) {
      var right = stack[--count2];
      var left = stack[--count2];
      var diff = right - left;
      if (diff > 16) {
...
DBVTBroadPhase.prototype = Object.assign(Object.create(BroadPhase.prototype), {
  ...
  collectPairs: function() {
    ...
    var leaf, margin = 0.1, i2 = this.numLeaves;
    while (i2--) {
      leaf = this.leaves[i2];
...
BoxBoxCollisionDetector.prototype = Object.assign(Object.create(CollisionDetector.prototype), {
  ...
  detectCollision: function(shape1, shape2, manifold) {
    ...
    for (i2 = 0; i2 < numClipVertices; i2++) {
      index = i2 * 3;
...
BoxCylinderCollisionDetector.prototype = Object.assign(Object.create(CollisionDetector.prototype), {
  ...
  getSep: function(c1, c2, sep, pos, dep) {
    ...
    var v0y = v02y - v01y;
    var v0z = v02z - v01z;
    if (v0x * v0x + v0y * v0y + v0z * v0z == 0) v0y = 1e-3;
    var nx = -v0x;
    var ny = -v0y;
    var nz = -v0z;
...
function World(o) {
  ...
  this.timerate = this.timeStep * 1e3;
  this.timer = null;
  this.preLoop = null;
  this.postLoop = null;
  ...
  this.isStat = o.info === void 0 ? false : o.info;
  if (this.isStat) this.performance = new InfoDisplay(this);
  this.enableRandomizer = o.random !== void 0 ? o.random : true;
  ...
  if (o.gravity !== void 0) this.gravity.fromArray(o.gravity);
  var numShapeTypes = 5;
  this.detectors = [];
  this.detectors.length = numShapeTypes;
  var i2 = numShapeTypes;
  while (i2--) {
    this.detectors[i2] = [];
    this.detectors[i2].length = numShapeTypes;
  }
...
Object.assign(World.prototype, {
  ...
  */
  step: function() {
    ...
    var i2 = this.broadPhase.numPairs;
    while (i2--) {
      var pair = pairs[i2];
      var s1;
      var s2;
    ...
    for (var base = this.rigidBodies; base !== null; base = base.next) {
      ...
      if (this.enableRandomizer) {
        ...
        while (j--) {
          if (j !== 0) {
            var swap = (this.randX = this.randX * this.randA + this.randB & 2147483647) / 2147483648 * j | 0;
  ...
  initBody: function(type, o) {
    ...
    var s = o.size === void 0 ? [1, 1, 1] : o.size;
    if (s.length === 1) {
      s[1] = s[0];
    }
    if (s.length === 2) {
    ...
    if (o.density !== void 0) sc.density = o.density;
    if (o.friction !== void 0) sc.friction = o.friction;
    if (o.restitution !== void 0) sc.restitution = o.restitution;
    if (o.belongsTo !== void 0) sc.belongsTo = o.belongsTo;
    if (o.collidesWith !== void 0) sc.collidesWith = o.collidesWith;
    if (o.config !== void 0) {
      if (o.config[0] !== void 0) sc.density = o.config[0];
      if (o.config[1] !== void 0) sc.friction = o.config[1];
      if (o.config[2] !== void 0) sc.restitution = o.config[2];
      if (o.config[3] !== void 0) sc.belongsTo = o.config[3];
      if (o.config[4] !== void 0) sc.collidesWith = o.config[4];
    }
    ...
    for (var i2 = 0; i2 < type.length; i2++) {
      n = i2 * 3;
      if (p2[n] !== void 0) sc.relativePosition.set(p2[n], p2[n + 1], p2[n + 2]);
      if (r2[n] !== void 0) sc.relativeRotation.setQuat(new Quat().setFromEuler(r2[n], r2[n + 1], r2[n + 2]));
      switch (type[i2]) {
        case "sphere":
    ...
    if (o.name !== void 0) body.name = o.name;
  ...
  initJoint: function(type, o) {
    ...
    var b1 = null;
    var b2 = null;
    if (o.body1 === void 0 || o.body2 === void 0) return printError("World", "Can't add joint if attach rigidbodys not define !");
